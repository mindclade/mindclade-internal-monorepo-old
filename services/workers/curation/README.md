...
Runs versioned scientific normalization, filtering, deduplication, consent/license/safety, provenance, and quality logic over immutable raw/canonical inputs.
...
- raw byte transfer and parser sandboxing;
