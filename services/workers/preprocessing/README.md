...
**Language:** Python with Rust node-agent tools  
**Status in this archive:** target-state adapter scaffold; not production-ready.

## Role

Executes MSA, template, ligand, pairing, and featurization stage semantics for durable full-pipeline predictions.
...
- global scheduling and database snapshot promotion;
- external tool process/resource supervision;
