...
// health hooks intact and no independent way to start.
//
...
func gateLeaderWork(name string, components ...servicekit.Component) (leadership.Handler, []servicekit.Component, error) {
	...
	gated := make([]servicekit.Component, 0, len(components))
