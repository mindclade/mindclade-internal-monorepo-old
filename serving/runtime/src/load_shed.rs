...
#[derive(Clone, Copy, Debug, Eq, PartialEq)] pub enum LoadShedDecision {
    Admit, RejectConcurrency, RejectQueue, RejectMemoryPressure, Drain
}

#[derive(Clone, Copy, Debug)] pub struct LoadShedder {
...
impl LoadShedder {
    #[must_use] pub fn decide(&self, active: u32, queued: u32, memory_pressure: u16, draining: bool) -> LoadShedDecision {
        if draining {
