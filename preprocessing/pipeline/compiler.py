    ...
    return tuple(
        {
            ...
            "kind": str(s.spec.kind),
            "dependencies": s.dependencies,
            "output_namespace": s.spec.output_namespace,
            "config_digest": s.spec.config_digest,
            "reference_snapshot_digest": s.spec.reference_snapshot_digest,
        }
