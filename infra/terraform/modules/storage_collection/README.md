...
| ---- | ----------- | ---- | ------- | :------: |
| <a name="input_bucket_iam_members"></a> [bucket\_iam\_members](#input\_bucket\_iam\_members) | Additive, bucket-scoped read grants keyed by stable Terraform identity. | <pre>map(object({<br/>    bucket_key = string<br/>    role       = string<br/>    member     = string<br/>  }))</pre> | `{}` | no |
...
| Name | Description |
| ---- | ----------- |
| <a name="output_bucket_iam_members"></a> [bucket\_iam\_members](#output\_bucket\_iam\_members) | n/a |
