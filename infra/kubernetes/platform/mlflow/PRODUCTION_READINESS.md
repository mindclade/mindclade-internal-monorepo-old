...
| Observed | Runtime dependency graph | PASS | separate hash lock includes MLflow auth/genai, PostgreSQL, GCS, and Redis support |
| Observed | Target platform | IN PROGRESS | OCI graph transition exists; Linux wheel inspection must pass |
