use mindclade_worker_protocol::{
    DetachedSignature, Ed25519KeySet, SignatureVerifier
};
...
fn verifies_go_stdlib_ed25519_ticket_signature() {
    let payload = include_bytes!("../../../../tests/integration/cross_language/fixtures/execution_ticket_claims_v1.bin");
    let public_key = decode_hex::<32>("79b5562e8fe654f94078b112e8a98ba7901f853ae695bed7e0e3910bad049664");
    ...
    verifier.verify(payload, &DetachedSignature {
        algorithm: "ed25519".into(), key_id: "runtime/cross-language-v1".into(), value: signature.to_vec()
