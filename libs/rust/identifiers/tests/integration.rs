...
#[test]fn generated_ids_round_trip_and_do_not_repeat() {
...
#[test]fn parses_go_compatible_uuidv7() {
    let id="run_019c0000000070008000000000000001".parse::<ResourceId>().expect("valid");
    assert_eq!(id.kind(), "run");
    assert_eq!(id.to_string(), "run_019c0000000070008000000000000001");
}

#[test]fn names_reject_traversal() {
